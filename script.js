document.addEventListener('DOMContentLoaded', () => {
    ...
    const bootPromise = new Promise((resolve) => {
        ...
        if (sessionStorage.getItem('tushar_os_booted')) {
        ...
        const bootLines = [
            { text: 'TUSHAR_OS v1.0', type: 'header', delay: 100 },
            { text: 'Initializing system...', type: 'system', delay: 400 },
            { text: '<span class="ok">[OK]</span> Loading profile modules', type: 'success', delay: 700 },
            { text: '<span class="ok">[OK]</span> Connecting Spring Boot services', type: 'success', delay: 1000 },
            { text: '<span class="ok">[OK]</span> Starting Node.js runtime', type: 'success', delay: 1300 },
            { text: '<span class="ok">[OK]</span> Mounting Docker containers', type: 'success', delay: 1600 },
            { text: '<span class="ok">[OK]</span> Deploying MERN stack', type: 'success', delay: 1900 },
            { text: '<span class="ok">[OK]</span> SQL pipelines online', type: 'success', delay: 2200 },
    ...
    function dissolveBoot(resolve) {
        ...
        setTimeout(() => {
            ...
            showContent();
            sessionStorage.setItem('tushar_os_booted', 'true');
            if (resolve) resolve();
        }, 600);
    }
    ...
    // Terminal data
    const termData = {
        about: `I'm a Full Stack Developer with hands-on experience in JavaScript (MERN) and Java. Experienced in building and optimizing high-volume data pipelines and SQL optimization in production environments.`,
        education: 'B.Tech Computer Science Engineering | Chitkara University, Punjab | Sep 2022-Present | CGPA: 8.15',
        phone: '+91 8146786435',
        email: 'tusharsingla1205@gmail.com',
...
<span class="term-key">about</span><span class="term-val">Learn about Tushar</span>
...
<span class="term-key">clear</span><span class="term-val">Clear terminal</span>
        ...
        about: () => {
            ...
            return `<div class="term-heading">About Tushar</div>
...
<div class="term-output"><strong style="color:var(--accent-blue)">Languages:</strong> <span class="term-tag">Java</span><span class="term-tag">JavaScript</span><span class="term-tag">SQL</span><span class="term-tag">C++</span></div>
<div class="term-output"><strong style="color:var(--accent-blue)">Backend:</strong> <span class="term-tag">Spring Boot</span><span class="term-tag">Node.js</span><span class="term-tag">Express.js</span><span class="term-tag">REST APIs</span></div>
<div class="term-output"><strong style="color:var(--accent-blue)">Databases:</strong> <span class="term-tag">MySQL</span><span class="term-tag">SSMS</span><span class="term-tag">MongoDB</span></div>
<div class="term-output"><strong style="color:var(--accent-blue)">DevOps:</strong> <span class="term-tag">Docker</span><span class="term-tag">Nginx</span><span class="term-tag">AWS</span><span class="term-tag">CI/CD</span><span class="term-tag">PM2</span></div>
<div class="term-output"><strong style="color:var(--accent-blue)">Frontend:</strong> <span class="term-tag">React.js</span><span class="term-tag">TailwindCSS</span><span class="term-tag">HTML/CSS</span></div>
<div class="term-output" style="margin-top:0.3rem; color: var(--text-muted); font-style: italic;">(Scrolling to section...)</div>`;
        },
...
<div class="term-output"><strong style="color:var(--accent-purple)">1. Attentify - Smart Attendance System</strong></div>
<div class="term-output">   Real-time face recognition via webcam for attendance</div>
<div class="term-output">   AI-based proxy prevention + JWT RBAC auth</div>
<div class="term-output">   <span class="term-tag">MERN</span><span class="term-tag">Flask</span><span class="term-tag">WebRTC</span><span class="term-tag">Facial-Recognition</span></div>
<div class="term-output" style="margin-top:0.3rem"><strong style="color:var(--accent-purple)">2. Socio-AI - Amazon Listing Converter</strong></div>
<div class="term-output">   Social media content to Amazon-ready product listings</div>
<div class="term-output">   <span class="term-tag">MERN</span><span class="term-tag">Flask</span><span class="term-tag">Next.js</span><span class="term-tag">Python</span></div>
<div class="term-output" style="margin-top:0.3rem"><strong style="color:var(--accent-purple)">3. User Session & Login Activity Tracker</strong></div>
<div class="term-output">   Secure Spring Boot APIs with IP/device logging</div>
<div class="term-output">   <span class="term-tag">Spring Boot</span><span class="term-tag">MySQL</span><span class="term-tag">JWT</span></div>
<div class="term-output" style="margin-top:0.3rem; color: var(--text-muted); font-style: italic;">(Scrolling to section...)</div>`;
        },
...
<div class="term-output"><strong style="color:var(--accent-blue)">Associate Engineer (SQL, C#)</strong></div>
<div class="term-output">Indus Valley Partners (IVP) | Noida | Jun 2025 - Present</div>
<div class="term-output" style="margin-top:0.2rem">- Designed ETL pipelines for production financial systems</div>
<div class="term-output">- Built and optimized SQL queries and stored procedures</div>
<div class="term-output">- Collaborated with senior engineers and cross-functional teams</div>
<div class="term-output">- Enterprise-scale MySQL/SSMS database systems</div>
<div class="term-output" style="margin-top:0.3rem; color: var(--text-muted); font-style: italic;">(Scrolling to section...)</div>`;
        },
...
<div class="term-output" style="margin-top:0.3rem; color: var(--text-muted); font-style: italic;">(Scrolling to section...)</div>`;
        ...
        resume: () => {
            ...
            a.href = 'Tushar_Singla_Resume.docx';
            a.download = 'Tushar_Singla_Resume.docx';
        ...
        whoami: () => '<div class="term-output">visitor@tushar-os</div>',

        pwd: () => '<div class="term-output">/home/tushar/portfolio</div>',

        date: () => '<div class="term-output">' + new Date().toLocaleString() + '</div>',

        uname: () => '<div class="term-output">TusharOS 2.0 - Built with vanilla HTML/CSS/JS</div>',
...
<span class="term-key">OS</span><span class="term-val">TusharOS v1.0</span>
<span class="term-key">Host</span><span class="term-val">tushar@portfolio</span>
<span class="term-key">Shell</span><span class="term-val">bash 5.1</span>
<span class="term-key">Languages</span><span class="term-val">Java, JavaScript, SQL, C++</span>
<span class="term-key">Frameworks</span><span class="term-val">Spring Boot, Node.js, React</span>
<span class="term-key">Cloud</span><span class="term-val">AWS (EC2, S3), Docker</span>
<span class="term-key">DevOps</span><span class="term-val">Docker, Nginx, CI/CD, PM2</span>
<span class="term-key">Uptime</span><span class="term-val">9 months</span>
<span class="term-key">CGPA</span><span class="term-val">8.15</span>
</div></div>`;
        },
...
<div class="term-output">Contact: <strong style="color:var(--accent-blue)">${termData.email}</strong></div>`;
    ...
    bootPromise.then(() => {
        setTimeout(() => {
            addTerminalOutput(`<div class="term-special">Welcome to TusharOS v1.0</div>`);
    ...
    const tourSteps = [
        { target: '#home .hero-text', text: "Welcome! I am Tushar's AI Assistant. Let's start the tour!", position: 'center' },
        { target: '#about .about-text', text: "Tushar is a Full Stack Developer building MERN apps and enterprise data pipelines.", position: 'center' },
        { target: '#experience .timeline-item', text: "He designs ETL pipelines and optimizes SQL at Indus Valley Partners!", position: 'center' },
        { target: '#skills .skills-grid', text: "His tech stack includes Spring Boot, Node.js, React, MySQL, and Docker.", position: 'center' },
        { target: '#projects .projects-grid', text: "Here are her top AI products: SCAI and SalesLens.", position: 'center' },
        { target: '#contact .contact-grid', text: "Want to hire him? Download his resume here!", position: 'center' }
    ];
    ...
    const GeoGreeting = (() => {
        ...
        function updateGreeting() {
            ...
            if (tourSteps && tourSteps[0]) {
                tourSteps[0].text = `Welcome, visitor from ${geoData.city}! I'm Tushar's AI. Let's explore!`;
            }
            // Update the AI speech if tour hasn't started
            if (speech && !tourActive) {
                speech.innerHTML = `Hi! I'm Tushar's AI. Click me for a tour!`;
            }
        }
...
<div class="term-output">3 packets transmitted, 3 received, 0% packet loss</div>`;
    ...
    if (radarSvg) {
        ...
        const skills = [
            { label: 'Backend', value: 0.9, techs: 'Spring Boot, Node.js, Express.js, REST APIs' },
            { label: 'DevOps', value: 0.75, techs: 'Docker, Nginx, AWS EC2/S3, CI/CD, PM2' },
            { label: 'Databases', value: 0.88, techs: 'MySQL, SSMS, MongoDB' },
            { label: 'Full Stack', value: 0.85, techs: 'MERN, Next.js, TailwindCSS' },
            { label: 'Data / ETL', value: 0.8, techs: 'ETL Pipelines, SQL Optimization, C#' },
            { label: 'Frontend', value: 0.75, techs: 'React.js, HTML/CSS, TailwindCSS' }
        ];
